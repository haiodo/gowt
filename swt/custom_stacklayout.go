...
func (this *StackLayout) ComputeSizeOnLayout(composite *Composite, wHint int32, hHint int32, flushCache bool) *Point {
	var maxWidth int32 = 0
	var maxHeight int32 = 0
	for _, element := range composite.GetChildren() {
		var size *Point = element.impl.ComputeSizeWHintHHintChangedOnControl(wHint, hHint, flushCache)
...
func (this *StackLayout) LayoutOnLayout(composite *Composite, flushCache bool) {
