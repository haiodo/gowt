...
func NewTextStyleFontForegroundBackground(font *Font, foreground *Color, background *Color) *TextStyle {
	this := &TextStyle{}
...
func NewTextStyleStyle(style *TextStyle) *TextStyle {
	this := &TextStyle{}
...
func (this *TextStyle) Equals(object any) bool {
	...
	style, ok434 := textStyleImplAsTextStyle(object)
	if !(ok434) {
		return false
	}
...
func (this *TextStyle) IsAdherentBorder(style *TextStyle) bool {
	if this == style {
		return true
	}
	if style == (nil) {
...
func (this *TextStyle) IsAdherentUnderline(style *TextStyle) bool {
	if this == style {
		return true
	}
	if style == (nil) {
...
func (this *TextStyle) IsAdherentStrikeout(style *TextStyle) bool {
	if this == style {
		return true
	}
	if style == (nil) {
