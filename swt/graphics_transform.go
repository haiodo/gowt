...
func NewTransform(device *Device) *Transform {
	this := &Transform{}
	this.impl = this
...
func NewTransformDeviceElements(device *Device, elements []float32) *Transform {
	this := &Transform{}
	this.impl = this
...
func NewTransformDeviceM11M12M21M22DxDy(device *Device, m11 float32, m12 float32, m21 float32, m22 float32, dx float32, dy float32) *Transform {
	this := &Transform{}
	this.impl = this
...
func (this *Transform) Invert() {
	...
	if (struct_.M11*struct_.M22 - struct_.M12*struct_.M21) == 0 {
		SWTErrorFn(SWTERROR_CANNOT_INVERT_MATRIX)
	}
	this.Handle.Invert()
}
...
func (this *Transform) Multiply(matrix *Transform) {
	if this.impl.IsDisposed() {
		SWTErrorFn(SWTERROR_GRAPHIC_DISPOSED)
	}
	if matrix == (nil) {
