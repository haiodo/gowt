...
func (this *FormData) ComputeSize(controlLike ControlLike, wHint int32, hHint int32, flushCache bool) {
	var control *Control
	if controlLike != nil {
...
func (this *FormData) GetWidth(controlLike ControlLike, flushCache bool) int32 {
	var control *Control
	if controlLike != nil {
		control = controlLike.AsControl()
	}
...
func (this *FormData) GetHeight(controlLike ControlLike, flushCache bool) int32 {
	var control *Control
	if controlLike != nil {
		control = controlLike.AsControl()
	}
...
func (this *FormData) GetBottomAttachment(controlLike ControlLike, spacing int32, flushCache bool) *FormAttachment {
	var control *Control
	if controlLike != nil {
		control = controlLike.AsControl()
	}
...
func (this *FormData) GetLeftAttachment(controlLike ControlLike, spacing int32, flushCache bool) *FormAttachment {
	var control *Control
	if controlLike != nil {
		control = controlLike.AsControl()
	}
...
func (this *FormData) GetTopAttachment(controlLike ControlLike, spacing int32, flushCache bool) *FormAttachment {
	var control *Control
	if controlLike != nil {
		control = controlLike.AsControl()
	}
